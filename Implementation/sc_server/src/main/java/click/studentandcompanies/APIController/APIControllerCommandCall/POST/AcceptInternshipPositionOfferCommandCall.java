...
public class AcceptInternshipPositionOfferCommandCall implements APIControllerCommandCall<ResponseEntity<DTO>> {
    ...
    public AcceptInternshipPositionOfferCommandCall(Integer intPosOffID, Map<String, Object> payload, InterviewManager interviewManager, NotificationManager notificationManager, UserManager userManager) {
    ...
    public ResponseEntity<DTO> execute() {
        try {
            ...
            NotificationData data = new NotificationData(NotificationTriggerType.INTERNSHIP_POSITION_OFFER_ACCEPTED , dto);
