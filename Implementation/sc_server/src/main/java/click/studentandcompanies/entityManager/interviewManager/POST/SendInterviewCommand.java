...
public class SendInterviewCommand implements InterviewManagerCommand<Interview> {
    ...
    public Interview execute() {
        ...
        if (!hasAllQuestions(payload)) {
            System.out.println("Not all questions found");
            throw new BadInputException("Not all questions found");
        }
    ...
    private boolean hasAllQuestions(Map<String, Object> payload) {
    ...
    private InterviewTemplate createInterviewTemplate(Map<String, Object> payload) {
        InterviewTemplate interviewTemplate =
                ...
                (String) payload.get("question1"),
                (String) payload.get("question2"),
                (String) payload.get("question3"),
                (String) payload.get("question4"),
                (String) payload.get("question5"),
                (String) payload.get("question6"));
