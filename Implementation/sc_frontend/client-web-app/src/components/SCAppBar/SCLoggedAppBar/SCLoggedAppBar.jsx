...
function SCLoggedAppBar({ onLeftIconClick, open, drawerWidth }) {
    ...
    >
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          >
            <SCDrawerIcon color="customIcon.main"></SCDrawerIcon>
          </IconButton>
          <Typography
            variant="h6"
            noWrap
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
            <IconButton
              ...
              color="inherit"
            >
              <SCMenuIcon color="customIcon.main" />
            </IconButton>
            <Menu
              id="menu-appbar"
